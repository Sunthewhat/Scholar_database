...
const NewUserPage: FC = () => {
	...
	const handleConfirmCreate = async () => {
		...
		try {
			const response = await Axios.post(`/auth/${selectedRole}`, {
	...
	return (
		<AuthWrapper requiredRole='admin'>
			<main className='h-screen w-screen bg-gradient-to-b from-violet-gd0 to-violet-gd100 overflow-hidden'>
				...
				{/* Success Modal */}
				<Modal isOpen={isSuccessModalOpen} onClose={handleSuccessClose} size='md'>
					<div className='text-center py-6'>
						...
						<div className='text-left bg-gray-100 p-4 rounded-lg mb-6'>
							<p className='text-sm text-gray-700 mb-2'>
								<strong>รหัสผ่านเริ่มต้น:</strong> zyxw4321
							</p>
						...
						<button
							...
							className='px-8 py-2 bg-violet-3 text-white rounded-lg hover:bg-violet-4 transition-colors'
						>
